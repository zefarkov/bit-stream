...
function pageLabels(lang){
  const m = {
    uz:{
      ...
      utility:'BITSTREAM / IT INFRASTRUCTURE / NEXT GENERATION NETWORK',
      sectionLink:'Sahifaga o‘tish',
      strictNote:'Dizayn ataylab qat’iy qilingan: rasmiy portal intizomi, tijoriy firma aniqligi va yumshoq “startup” uslubidan voz kechilgan.',
    ...
    ru:{
      ...
      strictNote:'Дизайн намеренно сделан строгим: дисциплина гос-портала, коммерческая чёткость и отказ от мягкой “стартапной” пластики.',
    ...
    en:{
      ...
      strictNote:'The design is intentionally strict: government-portal discipline adapted for a commercial IT firm, with tighter structure and no soft startup styling.',
